...
export class DelegatecallCreateAccountTx extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: DelegatecallCreateAccountTx): DelegatecallCreateAccountTx.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: DelegatecallCreateAccountTx, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): DelegatecallCreateAccountTx;
  static deserializeBinaryFromReader(message: DelegatecallCreateAccountTx, reader: jspb.BinaryReader): DelegatecallCreateAccountTx;
}
...
export class DelegatecallCommentTx extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: DelegatecallCommentTx): DelegatecallCommentTx.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  ...
  static deserializeBinaryFromReader(message: DelegatecallCommentTx, reader: jspb.BinaryReader): DelegatecallCommentTx;
}
...
export class AcceptAnswerTx extends jspb.Message {
  ...
  static deserializeBinaryFromReader(message: AcceptAnswerTx, reader: jspb.BinaryReader): AcceptAnswerTx;
}
...
export class DelegatecallAcceptAnswerTx extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: DelegatecallAcceptAnswerTx): DelegatecallAcceptAnswerTx.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: DelegatecallAcceptAnswerTx, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): DelegatecallAcceptAnswerTx;
  static deserializeBinaryFromReader(message: DelegatecallAcceptAnswerTx, reader: jspb.BinaryReader): DelegatecallAcceptAnswerTx;
}
...
export class StateQueryParams extends jspb.Message {
  ...
  static deserializeBinaryFromReader(message: StateQueryParams, reader: jspb.BinaryReader): StateQueryParams;
}
...
export class DelegatecallVoteTx extends jspb.Message {
  ...
  static deserializeBinaryFromReader(message: DelegatecallVoteTx, reader: jspb.BinaryReader): DelegatecallVoteTx;
}
